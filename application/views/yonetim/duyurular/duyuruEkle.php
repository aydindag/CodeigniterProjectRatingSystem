        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form method="post" role="form" action="<?php echo base_url('yonetimPaneli/duyuruEkleButton'); ?>">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Başlık</label>
                                <input name="baslik" required type="text" class="form-control" id="exampleInputEmail1" placeholder="Başlık girin">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                               <?php $info=$this->session->userdata('info'); ?>
                                ...
                                <input name="ekleyenisim" readonly required type="text" value="<?php echo $info->kullaniciAdi ?>" class="form-control" id="exampleInputEmail1" placeholder="Ekleyen İsmi">
