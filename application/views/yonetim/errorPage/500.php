    ...
    <section class="content">
        ...
        <div class="error-page">
            ...
            <div class="error-content" style="margin-top: 200px">
                <h3 style="margin-top:25px"><i class="fa fa-warning text-red"></i> Oops! Something went wrong.</h3>
                <p>
                    Could not connect to database.
                    <a href="#">Click</a> to report this error. Or <a href="#">Click</a> to login screen.
                </p>
