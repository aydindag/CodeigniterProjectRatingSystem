...
<body class="hold-transition login-page">
    ...
    <div class="login-box">        
        <div class="login-logo">
            <a href="<?php echo base_url("login") ?>"><b>Şifremi Unuttum</b></a>
        </div>
        <div class="alert alert-warning alert-dismissable">
        Email bölümüne;<br>
        Akademisyenler, <b>@karabuk.edu.tr</b>, öğrenciler ise <b>ogrno@ogrenci.karabuk.edu.tr</b> şeklinde girmeleri gerekir.
        </div>
        <!-- /.login-logo -->
        ...
        <div class="login-box-body">
            ...
            <form action="<?php echo base_url("yonetim/sifremiUnuttum") ?>" method="post">
                <div class="form-group has-feedback">
                    <select name="uyeTipi" class="form-control">
