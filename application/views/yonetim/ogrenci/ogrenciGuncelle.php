...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Öğrenci Güncelle</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Öğrenci Güncelle</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form method="post" role="form" action="<?php echo base_url('yonetimPaneli/ogrenciGuncelleButton/'); echo ''.$inf->ID.'' ?>">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="ogrNo" value="<?php echo $inf->ogrNo ?>" required type="text" class="form-control" id="exampleInputEmail1" placeholder="Öğrenci Numarası">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Şube</label>
                                <input name="sube" value="<?php echo $inf->sube ?>" required type="text" class="form-control" id="exampleInputEmail1" placeholder="sube">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Proje Kodu</label>
                                <input name="projeKodu" value="<?php echo $inf->projeKodu ?>" required type="text" class="form-control" id="exampleInputEmail1" placeholder="Proje Kodu">
